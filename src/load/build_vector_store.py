...
from load.utils.helpers.database import get_processed_chunk_ids
...
def run():
    ...
    for file_path in JSON_SOURCE_DIR.rglob("*.json"):
        ...
        video_metadata = {
            ...
            "show_name": video_data.get("show_name", "<NO SHOW NAME FOUND>"),
            "hosts": ",".join(
